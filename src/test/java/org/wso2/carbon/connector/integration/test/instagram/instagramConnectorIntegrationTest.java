...
public class instagramConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    public void setEnvironment() throws Exception {
        init("instagram-connector-1.0.2-SNAPSHOT");
    ...
    public void testGetUserInfoWithManditoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_getUserInfo_mandatory.json");

        String apiEndPoint = "https://api.instagram.com/v1/users/" + connectorProperties.getProperty("userId")
                + "/?access_token=" + connectorProperties.getProperty("accessToken");

        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);

        Assert.assertEquals(esbRestResponse.getBody().getJSONObject("data").get("username"),
                apiRestResponse.getBody().getJSONObject("data").get("username"));
        Assert.assertEquals(esbRestResponse.getBody().getJSONObject("data").get("id"),
                apiRestResponse.getBody().getJSONObject("data").get("id"));
        Assert.assertEquals(esbRestResponse.getBody().getJSONObject("data").get("full_name"),
                apiRestResponse.getBody().getJSONObject("data").get("full_name"));
    ...
    public void testGetUserInfoWithNegativeParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_getUserInfo_negative.json");

        String apiEndPoint = "https://api.instagram.com/v1/users/" + connectorProperties.getProperty("userId")
                + "/?access_token=" + connectorProperties.getProperty("token");

        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);

        Assert.assertEquals(esbRestResponse.getBody().getJSONObject("meta").get("error_message"),
                apiRestResponse.getBody().getJSONObject("meta").get("error_message"));
    ...
    @Test(groups = {"wso2.esb"},
            description = "instagram { getSelfMediaLiked} integration test with mandatory parameters.")
    public void testGetSelfMediaLikedWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_getSelfMediaLiked_mandatory.json");

        String apiEndPoint = "https://api.instagram.com/v1/users/self/media/liked?" + "access_token="
                + connectorProperties.getProperty("accessToken");

        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);

        Assert.assertEquals(apiRestResponse.getBody().getJSONObject("pagination").toString(),
                esbRestResponse.getBody().getJSONObject("pagination").toString());
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
    }
     ...
     */
    @Test(groups = {"wso2.esb"},
            description = "instagram { getSelfMediaLiked} integration test with optional parameters.")
    public void testGetSelfMediaLikedWithOptionalParameters() throws Exception {
        esbRequestHeadersMap.put("Action", "urn:getSelfMediaLiked");

        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_getSelfMediaLiked_optional.json");

        String apiEndPoint = "https://api.instagram.com/v1/users/self/media/liked?" + "access_token="
                + connectorProperties.getProperty("accessToken") + "&count=" + connectorProperties.getProperty("count");
    ...
    public void testGetSelfMediaLikedWithNegativeParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_getSelfMediaLiked_negative.json");
     ...
     */
    @Test(groups = {"wso2.esb"},
            description = "instagram { getUserMediaRecent} integration test with mandatory parameters.")
    public void testGetUserMediaRecentWithmandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_getUserMediaRecent_mandatory.json");

        String apiEndPoint = "https://api.instagram.com/v1/users/" + connectorProperties.getProperty("userId")
                + "/media/recent?" + "access_token=" + connectorProperties.getProperty("accessToken");

        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
        String mediaId = esbRestResponse.getBody().getJSONArray("data").getJSONObject(0).getString("id");
        connectorProperties.put("mediaId", mediaId);
        Assert.assertEquals(esbRestResponse.getBody().getJSONObject("pagination").toString(),
                apiRestResponse.getBody().getJSONObject("pagination").toString());
        Assert.assertEquals(esbRestResponse.getBody().getJSONObject("meta").get("code").toString(),
                apiRestResponse.getBody().getJSONObject("meta").get("code").toString());
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
    }
     ...
     */
    @Test(groups = {"wso2.esb"},
            description = "instagram { getUserMediaRecent} integration test with optional parameters.")
    public void testGetUserMediaRecentWithoptionalParameters() throws Exception {
        esbRequestHeadersMap.put("Action", "urn:getUserMediaRecent");
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_getUsermediaRecent_optional.json");

        String apiEndPoint = "https://api.instagram.com/v1/users/" + connectorProperties.getProperty("userId")
                + "/media/recent?" + "access_token=" + connectorProperties.getProperty("accessToken") + "&count="
                + connectorProperties.getProperty("count") + "&max_like_id="
                + connectorProperties.getProperty("maxLikeId") + "&max_timestamp="
                + connectorProperties.getProperty("maxTimestamp") + "&min_timestamp="
                + connectorProperties.getProperty("minTimestamp");
    ...
    public void testGetUserMediaRecentWithNegativeParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_getUserMediaRecent_negative.json");

        String apiEndPoint = "https://api.instagram.com/v1/users/" + connectorProperties.getProperty("userId")
                + "/media/recent?" + "access_token=" + connectorProperties.getProperty("token");
    ...
    public void tesUserSearchWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_userSearch_mandatory.json");

        String apiEndPoint = "https://api.instagram.com/v1/users/search?q="
                + connectorProperties.getProperty("queryName") + "&access_token="
                + connectorProperties.getProperty("accessToken");

        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
        Assert.assertEquals(apiRestResponse.getBody().getJSONArray("data").getJSONObject(0).get("id").toString(),
                esbRestResponse.getBody().getJSONArray("data").getJSONObject(0).get("id").toString());
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
    }
    ...
    public void tesUserSearchWithOptionalParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_userSearch_optional.json");

        String apiEndPoint = "https://api.instagram.com/v1/users/search?q="
                + connectorProperties.getProperty("queryName") + "&count=" + connectorProperties.getProperty("count") +
                "&access_token=" + connectorProperties.getProperty("accessToken");
    ...
    public void testGetUserFollowsWithOptionalParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_getUserFollows_mandatory.json");

        String apiEndPoint = "https://api.instagram.com/v1/users/" + connectorProperties.getProperty("userId")
                + "/follows?access_token=" + connectorProperties.getProperty("accessToken");

        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);

        Assert.assertEquals(esbRestResponse.getBody().getJSONArray("data").getJSONObject(0).get("username"),
                apiRestResponse.getBody().getJSONArray("data").getJSONObject(0).get("username"));
    ...
    public void testGetUserFollowsWithNegativeParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_getUserFollows_negative.json");

        String apiEndPoint = "https://api.instagram.com/v1/users/" + connectorProperties.getProperty("userId")
                + "/follows?access_token=" + connectorProperties.getProperty("token");
     ...
     */
    @Test(groups = {"wso2.esb"},
            description = "instagram { getUserFollowedBy} integration test with mandatory parameters.")
    public void testGetUserFollowedByMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_getUserFollowedBy_mandatory.json");

        String apiEndPoint = "https://api.instagram.com/v1/users/" + connectorProperties.getProperty("userId")
                + "/followed-by?" + "access_token=" + connectorProperties.getProperty("accessToken");
    ...
    public void testGetUserFollowedByNegativeParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_getUserFollowedBy_negative.json");

        String apiEndPoint = "https://api.instagram.com/v1/users/" + connectorProperties.getProperty("userId")
                + "/followed-by?" + "access_token=" + connectorProperties.getProperty("token");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getBody().getJSONObject("meta").get("error_message"),
                apiRestResponse.getBody().getJSONObject("meta").get("error_message"));
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 400);
     ...
     */
    @Test(groups = {"wso2.esb"},
            description = "instagram { getSelfRequestedBy} integration test with mandatory parameters.")
    public void testGetSelfRequestedByWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_getSelfRequestedBy_mandatory.json");

        String apiEndPoint = "https://api.instagram.com/v1/users/self/requested-by?access_token="
                + connectorProperties.getProperty("accessToken");
    ...
    public void testGetSelfRequestedByNegativeParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_getSelfRequestedBy_negative.json");
    ...
    public void testGetUserRelationshipWithOptionalParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_getUserRelationship_mandatory.json");

        String apiEndPoint = "https://api.instagram.com/v1/users/" + connectorProperties.getProperty("userId")
                + "/relationship?access_token=" + connectorProperties.getProperty("accessToken");

        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);

        Assert.assertEquals(esbRestResponse.getBody().getJSONObject("data").get("outgoing_status"),
                apiRestResponse.getBody().getJSONObject("data").get("outgoing_status"));
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
    }
    ...
    public void testGetUserRelationshipWithNegativeParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_getUserRelationship_negative.json");

        String apiEndPoint = "https://api.instagram.com/v1/users/" + connectorProperties.getProperty("userId")
                + "/relationship?access_token=" + connectorProperties.getProperty("token");
     ...
     */
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testGetUserMediaRecentWithmandatoryParameters"},
            description = "instagram { getMediaInfo} integration test with mandatory parameters.")
    public void testMediaInfoWithMandatoryParameters() throws Exception {
        esbRequestHeadersMap.put("Action", "urn:getMediaInfo");

        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_getMediaInfo_mandatory.json");

        String apiEndPoint = "https://api.instagram.com/v1/media/" + connectorProperties.getProperty("mediaId")
                + "/?access_token=" + connectorProperties.getProperty("accessToken");

        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);

        Assert.assertEquals(apiRestResponse.getBody().getJSONObject("data").get("type"),
                esbRestResponse.getBody().getJSONObject("data").get("type"));
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
    }
     ...
     */
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testGetUserMediaRecentWithmandatoryParameters"},
            description = "instagram { getMediaInfo} integration test with negative case.")
    public void tesTagSearchWithNegativeParameters() throws Exception {
        esbRequestHeadersMap.put("Action", "urn:getMediaInfo");

        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_getMediaInfo_negative.json");
    ...
    public void tesGetMediaSearchMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_getMediaSearch_mandatory.json");

        String apiEndPoint = "https://api.instagram.com/v1/media/search?lat=" + connectorProperties.getProperty("lat")
                + "&lng=" + connectorProperties.getProperty("lng") + "&access_token="
                + connectorProperties.getProperty("accessToken");

        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);

        Assert.assertEquals(apiRestResponse.getBody().getJSONArray("data").getJSONObject(0).get("type"),
                esbRestResponse.getBody().getJSONArray("data").getJSONObject(0).get("type"));
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
    }
    ...
    public void tesGetMediaSearchOptionalParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_getMediaSearch_optional.json");

        String apiEndPoint = "https://api.instagram.com/v1/media/search?lat=" + connectorProperties.getProperty("lat")
                + "&lng=" + connectorProperties.getProperty("lng") + "&max_timestamp="
                + connectorProperties.getProperty("maxTimestamp") + "&min_timestamp="
                + connectorProperties.getProperty("minTimestamp") + "&distance="
                + connectorProperties.getProperty("distance") + "&access_token="
                + connectorProperties.getProperty("accessToken");
    ...
    public void tesGetMediaSearchWithNegativeParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_getMediaSearch_negative.json");
     ...
     */
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testGetUserMediaRecentWithmandatoryParameters"},
            description = "instagram {getMediaComment} integration test with mandatory parameters.")
    public void testGetMediaCommentWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_get_media_comment_mandatory.json");

        String apiEndPoint = "https://api.instagram.com/v1/media/" + connectorProperties.getProperty("mediaId")
                + "/comments?access_token=" + connectorProperties.getProperty("accessToken");

        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);

        Assert.assertEquals(esbRestResponse.getBody().getJSONArray("data").getJSONObject(0).get("text"),
                apiRestResponse.getBody().getJSONArray("data").getJSONObject(0).get("text"));
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
    }
     ...
     */
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testGetUserMediaRecentWithmandatoryParameters"},
            description = "instagram {getMediaComment} integration test with negative case.")
    public void testGetMediaCommentWithNegativeParameters() throws Exception {
        esbRequestHeadersMap.put("Action", "urn:getMediaComment");

        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_get_media_comment_negative.json");

        String apiEndPoint = "https://api.instagram.com/v1/media/" + connectorProperties.getProperty("mediaId")
                + "/comments?access_token=" + connectorProperties.getProperty("token");
    ...
    public void tesGetMediaLikeWithMandatoryParameters() throws Exception {
        ...
        Assert.assertEquals(apiRestResponse.getBody().getJSONArray("data").getJSONObject(0).get("username"),
                esbRestResponse.getBody().getJSONArray("data").getJSONObject(0).get("username"));
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
    }
    ...
    public void tesGetMediaLikeWithNegativeParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_getMediaLike_negative.json");

        String apiEndPoint = "https://api.instagram.com/v1/media/" + connectorProperties.getProperty("media_id")
                + "/likes?" + "access_token=" + connectorProperties.getProperty("token");
    ...
    public void testGetTagInfoMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_getTagInfo_mandatory.json");

        String apiEndPoint = "https://api.instagram.com/v1/tags/" + connectorProperties.getProperty("tagName")
                + "/?access_token=" + connectorProperties.getProperty("accessToken");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
    ...
    public void testGetTagRecentMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_getTagRecent_mandatory.json");
        ...
        Assert.assertEquals(apiRestResponse.getBody().getJSONArray("data").getJSONObject(0).get("attribution"),
                esbRestResponse.getBody().getJSONArray("data").getJSONObject(0).get("attribution"));
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
    }
    ...
    public void testGetTagRecentNegativeParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_getTagRecent_negative.json");

        String apiEndPoint = "https://api.instagram.com/v1/tags/" + connectorProperties.getProperty("tagName")
                + "/media/recent?" + "access_token=" + connectorProperties.getProperty("token") + "&max_id="
                + connectorProperties.getProperty("maxId") + "&min_id=" + connectorProperties.getProperty("minId");
    ...
    public void tesTagSearchWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_getTagSearch_mandatory.json");

        String apiEndPoint = "https://api.instagram.com/v1/tags/search?q=" + connectorProperties.getProperty("query")
                + "&access_token=" + connectorProperties.getProperty("accessToken");

        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);

        Assert.assertEquals(apiRestResponse.getBody().getJSONArray("data").getJSONObject(0).get("media_count"),
                esbRestResponse.getBody().getJSONArray("data").getJSONObject(0).get("media_count"));
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
    }
    ...
    public void tesTagSearchhWithNegativeParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_getTagSearch_negative.json");
    ...
    public void testGetLocationInfoWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_get_location_info_mandatory.json");

        String apiEndPoint = "https://api.instagram.com/v1/locations/" + connectorProperties.getProperty("locationId")
                + "?access_token=" + connectorProperties.getProperty("accessToken");

        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);

        Assert.assertEquals(esbRestResponse.getBody().getJSONObject("data").get("longitude"),
                apiRestResponse.getBody().getJSONObject("data").get("longitude"));
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
    }
    ...
    public void testGetLocationInfoWithNegativeParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_get_location_info_negative.json");
    ...
    public void testGetLocationRecentWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_get_location_recent_mandatory.json");
        ...
        Assert.assertEquals(esbRestResponse.getBody().getJSONObject("pagination").get("next_max_id"),
                apiRestResponse.getBody().getJSONObject("pagination").get("next_max_id"));
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
    }
    ...
    public void testGetLocationRecentWithOptionalParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_get_location_recent_optional.json");

        String apiEndPoint = "https://api.instagram.com/v1/locations/" + connectorProperties.getProperty("locationId")
                + "/media/recent?access_token=" + connectorProperties.getProperty("accessToken") + "&max_timestamp="
                + connectorProperties.getProperty("maxTimestamp") + "&min_timestamp="
                + connectorProperties.getProperty("minTimestamp");
    ...
    public void testLocationSearchWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_location_search_mandatory.json");

        String apiEndPoint = "https://api.instagram.com/v1/locations/search?lat="
                + connectorProperties.getProperty("lat") + "&lng=" + connectorProperties.getProperty("lng")
                + "&access_token=" + connectorProperties.getProperty("accessToken");
    ...
    public void testLocationSearchWithOptionalParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_location_search_optional.json");

        String apiEndPoint = "https://api.instagram.com/v1/locations/search?lat="
                + connectorProperties.getProperty("lat") + "&lng=" + connectorProperties.getProperty("lng")
                + "&access_token=" + connectorProperties.getProperty("accessToken") + "&distance="
                + connectorProperties.getProperty("distance");
    ...
    public void testLocationSearchWithNegativeParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                "esb_location_search_negative.json");
